...
export const metadata: Metadata = {
  title: "Privacy Policy | Ananya Designer",
  description:
    "Understand how Ananya Designer collects, uses, and protects your personal data, including payment security and your rights.",
};
