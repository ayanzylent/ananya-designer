...
export const metadata: Metadata = {
  title: "Return, Refund & Exchange Policy | Ananya Designer",
  description:
    "Learn about Ananya Designer's return, exchange, and refund policy — including exchange window, conditions, damaged goods, and refund timelines.",
};
