...
export const metadata: Metadata = {
  title: "Shipping Policy | Ananya Designer",
  description:
    "Ananya Designer's shipping policy — delivery timeframes for India and international orders, shipping charges, and delay disclaimers.",
};
