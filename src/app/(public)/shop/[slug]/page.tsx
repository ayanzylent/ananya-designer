...
import { ChevronLeft, Check, ShoppingBag, Heart } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav
        ...
        className="px-4 sm:px-6 lg:px-8 pt-6 pb-2 max-w-7xl mx-auto"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          <div className="flex flex-col gap-6 md:sticky md:top-28">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {product.availableColors.map((color) => (
                    <span
                      key={color}
                      className="border border-border px-3 py-1.5 text-xs tracking-wide cursor-pointer hover:border-foreground transition-colors duration-200 first:border-foreground"
                    >
                      {color}
                    </span>
                  ))}
            ...
            <div className="flex flex-col gap-3 pt-2">
              ...
              {/* Row 2: WhatsApp enquiry — full width */}
              <a
                href={waUrl}
              ...
              <div className="pt-4 border-t border-border">
                ...
                <ul className="space-y-2">
                  {product.highlights.map((point) => (
                    ...
                    >
                      <Check
                        className="w-3.5 h-3.5 mt-0.5 flex-shrink-0 text-foreground"
                        aria-hidden="true"
                      />
                      {point}
                    </li>
