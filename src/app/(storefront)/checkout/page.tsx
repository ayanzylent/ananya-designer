            ...
            <CardContent className="pt-6 space-y-4">
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div
                  ...
                  className={`p-4 rounded-xl border-2 text-left cursor-pointer transition-all duration-200 ${paymentMethod === "razorpay"
                    ? "border-brand-500 bg-brand-500/5 shadow-[0_0_12px_rgba(99,102,241,0.15)]"
                    : "border-border/60 hover:border-border-hover bg-surface-secondary/40"
                    }`}
                >
                ...
                <div
                  ...
                  className={`p-4 rounded-xl border-2 text-left cursor-pointer transition-all duration-200 ${paymentMethod === "cod"
                    ? "border-brand-500 bg-brand-500/5 shadow-[0_0_12px_rgba(99,102,241,0.15)]"
                    : "border-border/60 hover:border-border-hover bg-surface-secondary/40"
                    }`}
                >
