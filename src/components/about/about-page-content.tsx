...
import { buildWhatsAppUrl, PHONE_NUMBER } from "@/lib/constants";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Ananya Designer is a homegrown fashion brand rooted in the heart
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              special event – Ananya Designer is your destination for outfits
